...
const forceSecureCookies = bool(process.env.FORCE_SECURE_COOKIES, false);
...
const env = {
  ...
  // Local HTTP cannot store Secure / SameSite=None cookies. Keep lax + insecure in development.
  cookieSameSite: !isProduction && !forceSecureCookies
    ? (process.env.COOKIE_SAME_SITE_DEV || "lax")
    : (process.env.COOKIE_SAME_SITE || "lax"),
  cookieSecure: !isProduction && !forceSecureCookies
    ? false
    : bool(process.env.COOKIE_SECURE, isProduction),
