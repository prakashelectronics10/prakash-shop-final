...
function renderAmpCatalogPage({ products, sourceType, origin }) {
  ...
  return ampShell({ title, description, canonicalUrl, ogImage: `${origin}/${wiring ? "og-image-wiring.jpg" : "og-image-shop-products.jpg?v=20260910-mobile"}`, jsonLd: { "@context": "https://schema.org", "@type": "CollectionPage", name: title, description, url: canonicalUrl, mainEntity: { "@type": "ItemList", itemListElement: itemList } }, body });
}
