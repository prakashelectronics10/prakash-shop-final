...
const requireAdmin = asyncHandler(async (req, res, next) => {
  ...
  const admin = await Admin.findOne({ _id: payload.sub, isActive: true }).select("_id name email role tag permissions adminAndroidAppAccess lastMobileLogin mobileAccessRequestedAt isActive");
  if (!admin) {
