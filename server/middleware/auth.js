...
const { clearAdminCookie, setAdminCookie } = require("../utils/cookie");
const {
  revokeSession,
...
const requireAdmin = asyncHandler(async (req, res, next) => {
  ...
  // Keep the persistent cookie fresh on real admin activity without changing its token.
  if (source === "cookie") setAdminCookie(res, token);
  next();
});
