...
router.post("/upload/image", requirePermission("offers", "services", "featuredRepairs", "gallery", "projectParts", "projectSliders", "shopProducts", "webSettings", "invoices"), upload.single("image"), uploadImage);
router.post("/upload/images", requirePermission("offers", "services", "featuredRepairs", "gallery", "projectParts", "projectSliders", "shopProducts", "webSettings", "invoices"), upload.array("images", 8), uploadImages);
router.delete("/upload/image", requirePermission("offers", "services", "featuredRepairs", "gallery", "projectParts", "projectSliders", "shopProducts", "webSettings", "invoices"), deleteUploadedImage);
