...
function DeferredSection({ children, minHeight = 420, anchorId }) {
  ...
  // Placeholder height only while waiting / loading — never keep a huge empty
  // minHeight after the real section content is on screen (that caused the
  // oversized gaps between Offers / Services / Gallery on phones).
  return (
    <div
      id={anchorId}
      ref={ref}
    ...
    >
      {visible ? (
        <Suspense fallback={<div style={{ minHeight: Math.min(minHeight, 360) }} aria-hidden="true" />}>
    ...
    <PublicShell>
      <div className="App">
        ...
        <main>
          ...
          <DeferredSection anchorId="services" minHeight={580}><Services sectionId="" /></DeferredSection>
          ...
          <DeferredSection minHeight={360}><QuickRouteCards /></DeferredSection>
          <DeferredSection anchorId="gallery" minHeight={520}><Gallery sectionId="" /></DeferredSection>
          <DeferredSection anchorId="featured-repairs" minHeight={480}><Carousel3D sectionId="" /></DeferredSection>
          <DeferredSection anchorId="about" minHeight={480}><About sectionId="" /></DeferredSection>
          <DeferredSection anchorId="contact" minHeight={520}><Contact sectionId="" /></DeferredSection>
        </main>
