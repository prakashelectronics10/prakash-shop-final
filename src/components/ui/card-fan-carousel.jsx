...
function isLowPowerDevice() {
  ...
  return coarse || (memory > 0 && memory <= 4) || (cores > 0 && cores <= 4);
}
  ...
  useEffect(() => {
    ...
    const updateHoverLayout = (hoveredSlot) => {
      ...
      visibleEntries.forEach(({ el, slot }) => {
        ...
        const lowPower = isLowPowerDevice() || prefersReducedMotion();
        ...
        gsap.to(el, {
          ...
          rotation: targetRot,
          scale: targetScale,
          duration: lowPower ? 0.28 : 0.5,
          delay: lowPower ? 0 : delay,
          ease: lowPower ? "power2.out" : "elastic.out(1,.75)",
          overwrite: "auto",
          force3D: true,
        });
      });
