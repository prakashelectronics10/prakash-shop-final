  ...
  return (
    <div className="App">
      ...
      <main className="relative min-h-screen overflow-hidden pt-32 pb-20">
        <div className="pointer-events-none absolute left-1/2 top-20 h-96 w-[80%] -translate-x-1/2 rounded-full bg-gradient-primary opacity-20 blur-3xl" />
        <div className="relative mx-auto grid max-w-6xl gap-8 px-4 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          ...
          <form onSubmit={submit} className="rounded-3xl glass-strong border-glow p-5 shadow-elegant md:p-8">
            ...
            <div className="mt-4">
              <Field label="Location / Address" placeholder="City, State or PIN code" value={form.address} onChange={(v) => update("address", v)} required />
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
              ...
              <div
                className={`flex min-h-36 cursor-pointer flex-col items-center justify-center gap-3 rounded-2xl glass border border-dashed p-5 text-center transition-all duration-300 ${isDragging
                    ...
                    {previews.map((preview, index) => (
                      <div key={index} className="relative group">
                        <img
                          ...
                          width={160}
                          height={112}
                          className="w-full h-24 sm:h-28 object-cover rounded-xl transition-all duration-300 group-hover:blur-sm"
                        />
                        <button
                          type="button"
                          onClick={() => {
            ...
            <button
              type="submit"
              disabled={busy || emailCheck.status === "checking"}
