    ...
    <>
      ...
      <aside className="science-ai-sidebar">
        ...
        <div className="ai-sidebar-card">
          ...
          <strong>Ask for products, repairs, wiring accessories, or service guidance and I will match the best next step.</strong>
        </div>
      </aside>
  ...
  return (
    <div className="ai-empty-state">
      <div className="ai-empty-copy">
        ...
        <h2>Pulse AI</h2>
        <p>
          Pulse AI is your friendly commerce and repair assistant for products, wiring accessories, RGB lights, electrical parts, and service bookings.
        </p>
      </div>
