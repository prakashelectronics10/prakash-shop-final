...
import { ArrowUpRight, Bot, Camera, Check, ChevronDown, Cpu, ImagePlus, Images, Moon, PackageSearch, PanelLeftClose, PanelLeftOpen, Plus, Send, ShoppingCart, Sparkles, Sun, Trash2 } from "lucide-react";
...
const starterPrompts = [
  "Make a water level indicator project",
  "Suggest parts for a rain alarm",
  "Help me troubleshoot an Arduino sensor",
];
    ...
    <>
      ...
      <main className="science-ai-chat">
        ...
        <section className="ai-messages" aria-live="polite">
          {!hasStarted && <EmptyState onSelectPrompt={setInput} />}
...
function EmptyState({ onSelectPrompt }) {
  return (
    <div className="ai-empty-state">
      <div className="ai-empty-mark"><Sparkles size={24} /></div>
      <h2>Science AI</h2>
      <p>Ready for your next science project.</p>
