  ...
  return (
    <section id={sectionId || undefined} className="site-section relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative mt-10 flex h-[min(440px,70vw)] min-h-[300px] items-center justify-center [perspective:1400px] sm:mt-12 sm:h-[440px]">
          {cards.map((card, i) => {
            const rel = getRel(i);
            ...
            return (
              ...
              >
                <div
                  className={`relative cursor-pointer overflow-hidden rounded-3xl border-glow p-6 sm:p-8 shadow-elegant select-none ${
                    rel === 0
                      ? "featured-repair-card-active shadow-glow"
                      : "featured-repair-card-side"
                  } bg-main-bg dark:bg-dark-main-bg`}
                >
                  {!prefersReducedMotion && rel === 0 && (
