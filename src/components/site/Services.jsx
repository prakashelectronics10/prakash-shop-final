      ...
      <div className="absolute inset-0">
        {card.imgUrl ? (
          <OptimizedImage
            ...
            width={480}
            height={760}
            sizes="(min-width: 1024px) 264px, (min-width: 768px) 224px, 160px"
...
export function Services({ sectionId = "services" }) {
  ...
  return (
    <section id={sectionId || undefined} className="relative overflow-x-hidden overflow-y-visible py-24">
      ...
      <div className="relative mt-8 sm:mt-10">
        <SocialCards
          cards={cards}
          renderCard={(card) => <ServiceFanCard card={card} />}
        />
      </div>
    </section>
  );
