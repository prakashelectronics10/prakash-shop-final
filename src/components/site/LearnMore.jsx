...
export function LearnMore() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="pointer-events-none fixed -right-32 top-10 h-96 w-96 rounded-full bg-gradient-primary opacity-20 blur-3xl" />
      <div className="relative mx-auto max-w-7xl px-4 py-8 md:py-12">
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="relative">
            <div className="absolute -inset-5 rounded-[2rem] bg-gradient-primary opacity-30 blur-2xl" />
