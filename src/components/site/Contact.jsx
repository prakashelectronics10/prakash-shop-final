        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form
              ...
              className="rounded-3xl glass-strong border-glow p-6 shadow-elegant md:p-8"
            >
              ...
              <button
                ...
                className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-glow transition-transform duration-300 hover:scale-[1.02]"
              >
                <Send className="h-4 w-4" />
                {content?.submitButtonText || "Submit Review"}
              </button>
...
function StarRatingField({
  ...
  return (
    <div>
      ...
      <div
        className="flex min-h-[46px] items-center gap-2 rounded-xl glass border border-border bg-transparent px-4 py-3"
        ...
        {Array.from({ length: 5 }).map((_, index) => {
          ...
          return (
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-md text-amber-400 outline-none transition-transform hover:scale-110 focus-visible:ring-2 focus-visible:ring-primary"
              onClick={() => onChange(value)}
              onMouseEnter={() => onHover(value)}
            >
              <Star className="h-6 w-6" fill={filled ? "currentColor" : "none"} />
            </button>
          );
        })}
...
function InfoCard({
  ...
  return (
    <Tag
      ...
      className="group flex items-start gap-4 rounded-2xl glass border-glow p-4 transition-transform hover:-translate-y-0.5"
    >
