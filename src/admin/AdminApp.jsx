...
function AdminManager({ admins, currentAdmin, runAction, busy }) {
  const empty = { name: "", email: "", role: "admin", password: "", tag: "employee", permissions: [], isActive: true };
  ...
  const edit = (item) => {
    ...
    setForm({
      name: item.name || "",
      email: item.email || "",
      role: ["admin", "manager", "editor"].includes(item.role) ? item.role : "admin",
      password: "",
  ...
  return (
    <div className="manager-grid">
      ...
      <section className="list-panel glass-panel">
        ...
        {admins.map((item) => (
          <div className="list-item compact" key={item._id || item.id}>
            <div>
    ...
    <div className="manager-grid">
      <section className="editor glass-panel">
        ...
        <div className="two-col">
          ...
          />
          <Input label="Icon name" value={form.iconName} onChange={(iconName) => setForm({ ...form, iconName })} />
    ...
    <section className="editor glass-panel single">
      ...
      <RepeatableRows
        ...
        renderItem={(badge, update) => (
          <div className="two-col">
            <Input label="Icon name" value={badge.iconName} onChange={(iconName) => update({ iconName })} />
    ...
    <section className="editor glass-panel single">
      ...
      <RepeatableRows
        ...
        renderItem={(reason, update) => (
          <>
            <div className="two-col">
              <Input label="Icon name" value={reason.iconName} onChange={(iconName) => update({ iconName })} />
  ...
  if (key === "testimonials") {
    return {
      ...
      items: (form.items || [])
        ...
        .map((item) => ({ ...item, rating: Number(item.rating || 5) })),
    };
  }
